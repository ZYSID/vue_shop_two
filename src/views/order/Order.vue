...
<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 表格 -->
      <el-table :data="orderlist[0].goods"
                border>
        ...
        <el-table-column prop="pay_staus"
                         label="是否付款"
                         width="90"
                         align="center">
          <template slot-scope="scope">
            <el-tag type="success"
                    v-if="scope.row.pay_staus === '1'">已付款</el-tag>
            <el-tag type="danger"
                    v-else>未付款</el-tag>
          </template>
        </el-table-column>
      ...
      <el-pagination @size-change="handleSizeChange"
                     ...
                     :current-page="queryInft.pagenum"
                     :page-sizes="[1, 2, 3, 4]"
                     :page-size="queryInft.pagesize"
...
<script>
import citydata from '@/views/goods/citydata'
